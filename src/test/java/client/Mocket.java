...
public class Mocket extends Socket {
  ...
  /**
   * @param testLog what the server has received from the client
   * @param node the JsonNode to use.
   */
  public Mocket(ByteArrayOutputStream testLog, JsonNode node) {
    this.testLog = testLog;
  ...
  /**
   * Returns this mocket's inputstream.
   *
   * @return - this mocket's inputstream.
   */
  @Override
  ...
  /**
   * Returns this mocket's outputStrema.
   *
   * @return - this mocket's outputStream.
   */
  @Override
